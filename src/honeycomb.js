/*
  ...
  start there.
*/
export var zoom; // declare the zoom variable
export var speed; // declare the speed variable

export function sliderZoom(v) { // new function for zoom
  // zoom = 1 + v * 20; // set zoom range, adjust this value as per the requirement
  // zoom = 20 - v * 19; // set zoom range, adjust this value as per the requirement
  zoom = 0.25 + v * 0.75; // set zoom range from 0.5 to 1

}

export function sliderSpeed(v) { // new function for speed
  speed = 1 + (1-v) * 9; // set speed range from 1 to 10
}

export function beforeRender(delta) {

  tf = speed // use the speed variable to control animation speed
